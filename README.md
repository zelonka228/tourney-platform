...
- **Backend REST API** (Express + Prisma) — CRUD команд і турнірів, генерація сітки, ввід рахунку, валідація вхідних даних, єдина обробка помилок (`400` / `404` / `409`), 36 автоматизованих тестів.
...
| 8 | Алгоритм генерації турнірної сітки (single/double elimination) | 3 | ![partial](https://img.shields.io/badge/-single%20elim.%20готово-yellow?style=flat-square) |
